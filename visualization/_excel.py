...
def save_to_existing_excel(sheets: list[dict[str, pd.DataFrame| str | bool]], path: str = ROOT_PATH, file: str = EXCEL_FILE) -> None:
...
def save_to_new_excel(sheets: list[dict[str, pd.DataFrame| str | bool]], path: str = ROOT_PATH, file: str = EXCEL_FILE) -> None:
    writer = get_writer(path, file)
...
def get_writer(path: str = ROOT_PATH, file: str = EXCEL_FILE) -> pd.ExcelWriter:
